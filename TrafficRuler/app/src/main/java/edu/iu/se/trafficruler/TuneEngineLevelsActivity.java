 ...
 */
public class TuneEngineLevelsActivity extends FragmentActivity {
    Button btuneengine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  btuneengine=(Button) findViewById(R.id.tune_up_engine_button);
        ...
        TuneUpLeftFragment leftFrag=new TuneUpLeftFragment();
        TuneUpEngineLevels rightFrag1= new TuneUpEngineLevels();
        UpgradeHandlingLevels rightFrag2= new UpgradeHandlingLevels();
        ImproveAccelerationLevels rightFrag3= new ImproveAccelerationLevels();
    ...
    public void OnTuneUpLevelClick(View view) {
        ...
        switch(view.getId())
        {
            case R.id.tune_up_engine_button:
                ...
                break;
            case R.id.upgrade_handling_button:
                ...
                break;
            case R.id.improve_acceleration_button:
